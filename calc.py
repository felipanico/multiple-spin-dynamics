...
def exchangeInteraction(sx, sy, sz, index, spinTotal):
	...
	for k in range(spinTotal):
		...
		spinA = [sx[previousSpinIndex], sx[previousSpinIndex], sx[previousSpinIndex]]
		
		spinB = [sx[k], sy[k], sz[k]]

		spinC = [sx[nextSpinIndex], sx[nextSpinIndex], sx[nextSpinIndex]]
	...
	#if (math.isnan(spinInteractionX)):
		#print(previousSpinIndex, nextSpinIndex)
		#print(sx)
		#sys.exit()

	#print(spinInteraction)
